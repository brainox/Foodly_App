...
struct ProfileService {
    ...
    func createProfile(with profileData: ProfileModel, completion: @escaping NetworkRouterCompletion) {
        router.request(.createProfile(data: profileData), completion: completion)
    }
